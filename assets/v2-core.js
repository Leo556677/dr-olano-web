...
function showDraft(d){$('#draftTitle').textContent=d.status==='sent'?'Solicitud enviada':'Cita pendiente';$('#draftText').textContent=d.status==='sent'?'Falta confirmación del centro.':'Continúa donde lo dejaste.';$('#draftPill').classList.add('show')}
